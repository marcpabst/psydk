    ...
    pub fn new(
        ...
        let mut stim = Self {
            ...
            params: ButtonParams {
                ...
                text_size,
                text_color,
                text_color_hover: text_color_hover.unwrap_or(text_color),
                text_color_pressed: text_color_pressed.unwrap_or(text_color),
                text_color_disabled: text_color_disabled.unwrap_or(Color::default()),
                fill_color,
                fill_color_hover: fill_color_hover.unwrap_or(fill_color),
                fill_color_pressed: fill_color_pressed.unwrap_or(fill_color),
