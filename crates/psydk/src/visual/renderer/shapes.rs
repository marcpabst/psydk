...
impl Shape {
    ...
    pub fn rectangle(topleft: impl Into<Point>, width: f32, height: f32) -> Self {
        let a = topleft.into();
        let width = width;
        let height = height;
    ...
    pub fn rounded_rectangle(topleft: impl Into<Point>, width: f32, height: f32, radius: f32) -> Self {
        let a = topleft.into();
        let width = width;
        let height = height;
    ...
    pub fn ellipse(center: impl Into<Point>, radius_x: f32, radius_y: f32, rotation: f32) -> Self {
        Self::Ellipse {
            center: center.into(),
            radius_x,
            radius_y,
